...
def main():
    ...
    if args.data_mutation: answer_dir = f"YOUR_PATH/{args.bench_name}/model_answer_{args.data_mutation}"
    else: answer_dir = f"YOUR_PATH/{args.bench_name}/model_answer"
